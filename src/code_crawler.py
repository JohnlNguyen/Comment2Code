...
def extract_code(start_lineno, file_name):
	...
	if heuristic == Heuristic.BLANK_LINE or heuristic == Heuristic.NEXT_COMMENT:
	...
	try:
		...
		with open(csv_file_name, newline='') as csv_file:
			...
			for row in map(DataRow._make, reader):
				...
				change_type = GitChange.COMMENT if af_comment == bf_comment or bf_code == af_code else GitChange.BOTH
